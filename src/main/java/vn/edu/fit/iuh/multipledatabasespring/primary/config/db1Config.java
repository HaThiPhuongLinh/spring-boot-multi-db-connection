package vn.edu.fit.iuh.multipledatabasespring.primary.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"vn.edu.fit.iuh.multipledatabasespring.primary.repositories"}
)
public class db1Config {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
        ...
        return builder
                ...
                .packages("vn.edu.fit.iuh.multipledatabasespring.primary.models")
                .properties(props)
                .build();
    }
